...
// void encode_bit_tree(uint bits, Prob* probs, size_t num_bits, EncoderInterface* enc);
// void encode_bit_tree_reverse(uint bits, Prob* probs, size_t num_bits, EncoderInterface* enc);
// void encode_direct_bits(uint bits, size_t num_bits, EncoderInterface* enc);
