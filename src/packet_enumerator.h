...
void packet_enumerator_callback(const PacketEnumerator* enumerator, const LZMAState* state, unsigned parent, PacketEnumeratorCallback callback, void* user_data);
